Фриланс проект, обычная форма после заполнения которой данные обрабатываются и записываются в .docx документ. Так же на основе введенных данных происходит обращение к api сервисам гугл для определения координат,дистанции,статической картинки карты. Так же происходит парсинг/обращение к API с официального сайта минестерства Британии о загрязнениях Радоном, наводнений, сертификатов энергоэффективности и тп.

К сожалению библиотека не оптимизированна для версии 7.4 php. 
